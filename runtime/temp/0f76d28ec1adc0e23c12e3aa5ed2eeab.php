<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"G:\php study\WWW\thinkphp\thinkphp\public/../application/admin\view\news\voice.html";i:1512472904;s:79:"G:\php study\WWW\thinkphp\thinkphp\public/../application/admin\view\layout.html";i:1512522060;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<div class="crumb-wrap">
    <div class="crumb-list"><i class="icon-font"></i>
        ...
        <span class="crumb-step">&gt;
            ...
            </span><span>语音</span></div>
</div>
<div class="result-wrap">
    <div class="result-content">
        <form action="/admin/news/uploadv" method="post" id="myform" name="myform" enctype="multipart/form-data">
            <table  width="100%">
                <tbody>
                <tr>
                ...
                <tr>
                    <?php if(is_array($voice) || $voice instanceof \think\Collection || $voice instanceof \think\Paginator): $i = 0; $__LIST__ = $voice;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <td>
                        <img src="/<?php echo $vo['image']; ?>" alt="" height="140px" width="140px"><br>
