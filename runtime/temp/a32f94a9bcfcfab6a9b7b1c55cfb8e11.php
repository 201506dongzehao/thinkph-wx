<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"G:\php study\WWW\thinkphp\thinkphp\public/../application/admin\view\news\index.html";i:1511917098;s:79:"G:\php study\WWW\thinkphp\thinkphp\public/../application/admin\view\layout.html";i:1512522060;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
        ...
        <div class="result-content">
            <table class="result-tab" width="100%">
                ...
                <?php if(is_array($pages) || $pages instanceof \think\Collection || $pages instanceof \think\Paginator): $i = 0; $__LIST__ = $pages;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td><a href="/admin/news/responseMsg"><?php echo $vo['username']; ?></a></td>
                        <td>
                            <?php echo $vo['news']; ?>
                        </td>
                        <td>
