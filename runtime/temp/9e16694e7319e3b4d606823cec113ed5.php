<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"G:\php study\WWW\thinkphp\thinkphp\public/../application/home\view\user\login.html";i:1512009161;s:78:"G:\php study\WWW\thinkphp\thinkphp\public/../application/home\view\layout.html";i:1511337452;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="admin_login_wrap">
    ...
    <div class="adming_login_border">
        <div class="admin_input">
            <form action="/home/user/dologin" method="post">
                <ul class="admin_items">
                    ...
                    <li>
                        <label>验证码：<input type="text" name="captcha" size="27" class="admin_input_style"></label>
                        <img src="<?php echo captcha_src('login'); ?>" onclick="changeCaptcha(this)">
                    </li>
                    <li>
                        <input type="submit" name="login" tabindex="3" value="提交" class="btn btn-primary" />
                    </li>
                </ul>
            </form>
        </div>
