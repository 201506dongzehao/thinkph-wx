...
class UserController extends Controller
{
    ...
    public function doregister(Request $request)
    {
        ...
        if ($user->save()){
            //注册成功
            return $this->success('注册成功！','http://dzhao.wywwwxm.com/thinkphp/public/index.php/home/user/login');
        }else{
            //注册失败
    ...
    public function dologin()
    {
        ...
        if ($user){
            ...
            //跳转
            return $this->success('用户登陆成功！','http://dzhao.wywwwxm.com/thinkphp/public/index.php/admin/index/index');
        }else{
